...
class LocalLlmClient:
    ...
    @staticmethod
    def is_enabled() -> bool:
        return settings.ASSISTANT_LLM_ENABLED and settings.ASSISTANT_LLM_PROVIDER.lower() == 'ollama'
    ...
    async def parse_query(self, query: str, session_context: dict[str, Any]) -> LlmParseResult | None:
        ...
        schema = {
            ...
            'required': ['intent', 'confidence', 'film_title', 'person_name', 'search_queries', 'requires_auth', 'reason'],
