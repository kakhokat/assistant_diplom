...
class Settings(BaseSettings):
    ...
    ASSISTANT_PARSE_CACHE_TTL_SECONDS: int = Field(default=86400, alias='ASSISTANT_PARSE_CACHE_TTL_SECONDS')
    ASSISTANT_PARSE_CACHE_KEY_PREFIX: str = Field(default='assistant_parse_cache', alias='ASSISTANT_PARSE_CACHE_KEY_PREFIX')
    ASSISTANT_PARSE_CACHE_VERSION: str = Field(default='v1', alias='ASSISTANT_PARSE_CACHE_VERSION')

    ASSISTANT_PUBLIC_RESPONSE_CACHE_TTL_SECONDS: int = Field(default=900, alias='ASSISTANT_PUBLIC_RESPONSE_CACHE_TTL_SECONDS')
    ASSISTANT_PUBLIC_RESPONSE_CACHE_KEY_PREFIX: str = Field(default='assistant_public_response_cache', alias='ASSISTANT_PUBLIC_RESPONSE_CACHE_KEY_PREFIX')

    ASSISTANT_FEEDBACK_KEY_PREFIX: str = Field(default='assistant_feedback', alias='ASSISTANT_FEEDBACK_KEY_PREFIX')
    ASSISTANT_FEEDBACK_MAX_EVENTS: int = Field(default=5000, alias='ASSISTANT_FEEDBACK_MAX_EVENTS')

    ASSISTANT_LLM_FAILURE_THRESHOLD: int = Field(default=3, alias='ASSISTANT_LLM_FAILURE_THRESHOLD')
    ASSISTANT_LLM_COOLDOWN_SECONDS: int = Field(default=60, alias='ASSISTANT_LLM_COOLDOWN_SECONDS')
